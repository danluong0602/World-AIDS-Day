...
<head>
    ...
    <title>World AIDS Day - Tìm hiểu về HIV/AIDS</title>
    <style>
        body {
        ...
        .banner {
            background-image: url('https://lh3.googleusercontent.com/pw/AP1GczNAIdZ7JsU7XUT2MM0emQAtnZsdScjVQKNCRSk3ODOG6bUKe1piFOQyTy48KVB1x6_RjJGA-eXAhiyfPa1mpuFK0KmJZnZZYLebAkLbGiUdWV0eUA=w2400');
            height: 400px;
...
<body>
    <header>
        ...
        <div class="header-logos">
            <img class="img-responsive" alt="Logo 1" src="https://84864c160d.vws.vegacdn.vn/UploadImages/Config/thptduongvanduong/Logo/logo-01.png">
            <img class="img-responsive" alt="Logo 2" src="https://lh3.googleusercontent.com/pw/AP1GczNyLL1QtsdXOcFMtRSRx5xOjlRpBxSamysraju5BPWEGdI0mJsvu5cuDtREWZo2mxP-zMaWtCjBNXeDYmzCcUfl25LnZIujhoBryX3l4jyhStfxlw=w2400">
        </div>
<hr>
<div><strong>NGÀY THẾ GIỚI PHÒNG CHỐNG AIDS</strong></div>
    </header>

    <nav>
        <a href="#hiv">HIV là gì?</a>
        <a href="#aids">AIDS là gì?</a>
        <a href="#transmission">Con đường lây truyền</a>
        <a href="#symptoms">Triệu chứng</a>
        <a href="#chandoan">Chẩn đoán</a>
	<a href="#dieutri">Điều trị</a>
        <a href="#prevention">Phòng ngừa</a>
        <a href="#hiv/aids">Những quan niệm sai lầm về HIV/AIDS</a>
    </nav>
...
<div class="content">
        ...
        <section id="transmission">
            <h2>3. Con đường lây truyền HIV</h2>
            <img src="https://lh3.googleusercontent.com/pw/AP1GczNOVlXQ2TRSe9XHhcfPXrYOvU0Pz5IgPN9EJ32AYj7k_Yy52L2yAKbHMyzTcIhRsIiZ9OaPF3CZ1v5WZ47rEeweIIO3KF8nW3IlEx14Zh2hYNdlxg=w2400" alt="Con đường lây truyền HIV">
...
<h2>7. Phòng ngừa HIV</h2>
<img class="img-responsive" alt="bienphap" src="https://lh3.googleusercontent.com/pw/AP1GczNQ8anjxMFLERbhDj0nrS9EudzzjAggUzwVzUieOyR-ogWtG2xnBIowQ_0REjujd7MfrFm1_GowG32h8oCE-J-kYpqItGcpZK7tUlMSIOxdDV9gTGM=w2400">
...
<section id="hiv/aids">
<h2>8. Những quan niệm sai lầm về HIV/AIDS</h2>
...
<body>
    ...
    <iframe 
        src="https://fluidforms.co/embed/form?id=67506f49f6259a93eae175de" 
        width="100%" 
        height="600" 
        frameborder="0" 
        style="border: none;">
...
<h3>THÀNH VIÊN THỰC HIỆN</h3>
            ...
            <p>Lương Đức Dân - 12B8</p>
            <p>Đặng Phước Đông - 12B8</p>
            <p>Nguyễn Thanh Phúc - 12B8</p>
            <p>Phạm Hoàng Khiêm - 12B8</p>
            <p>Mai Thị Ngọc Linh - 12B8</p>
...
<p class="footer-note">*Trang web và hình ảnh được thiết kế bởi nhóm</p>
